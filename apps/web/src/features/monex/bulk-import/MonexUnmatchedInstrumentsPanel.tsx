...
type MonexUnmatchedInstrumentsPanelProps = {
...
export function MonexUnmatchedInstrumentsPanel({
  candidates,
  instruments,
  disabled,
  onCreate,
}: MonexUnmatchedInstrumentsPanelProps) {
              ...
              >
                <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      void (async () => {
                        setCreatingName(candidate.instrumentName);
                        await onCreate(candidate);
                        setCreatingName(null);
                      })();
                    }}
                  >
                    {creatingName === candidate.instrumentName ? "登録中…" : "銘柄を登録"}
                  </Button>
                </div>
                {similar.length > 0 ? (
